        ...
        users.forEach((el, index) => {
            table.innerHTML += (`
                <tr class=${lineColor(index)}>
                    ...
                    <td>${el.name}</td>
                    <td>${el.email}</td>
                    <td onclick='change(${el.id},"${el.name}","${el.email}")'><span class="material-symbols-outlined">edit</span></td>
                    <td onclick="del(${el.id})"><span class="material-symbols-outlined">close</span></td>
                </tr>
            `)
        });
